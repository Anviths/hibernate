...
public class Test {
	...
	public static void main(String[] args) {
		...
		User user = new User();
		user.setName("shaw");
		user.setEmail("bigshow@gmail.com");
		...
		foodProduct1.setAvaliability(AailiabilityType.AVAILABLE);
		...
		foodOrder2.setOrderDeliveryTime(OrderTime._1HOUR);
